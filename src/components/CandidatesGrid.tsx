...
function CandidateCard({
	...
	return (
		...
		>
			...
			<button
				onClick={onExpand}
				className="absolute bottom-3 right-3 p-2 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-all hover:scale-110"
