...
export function ExpandedCandidateView({
  ...
  const availabilityColor = {
    looking: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400',
    open: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400',
    'not-looking': 'bg-neutral-100 text-neutral-600 dark:bg-neutral-800 dark:text-neutral-400',
  };
      ...
      >
        ...
        <div className="p-6 sm:p-8 space-y-6 sm:space-y-8 text-center">
          ...
          <div>
            ...
            >
              <ReactMarkdown remarkPlugins={[remarkGfm]} components={bioMarkdownComponents}>
                {candidate.bio}
              </ReactMarkdown>
            </div>
          </div>
