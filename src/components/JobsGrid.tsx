                    ...
                    <div className="flex items-center justify-center sm:justify-end gap-2">
                      ...
                      <a
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-full transition-colors ${
                          isHotJob(job)
                            ? "bg-gradient-to-r from-orange-800 to-amber-800 dark:from-orange-700 dark:to-amber-700 text-white hover:from-orange-900 hover:to-amber-900 dark:hover:from-orange-600 dark:hover:to-amber-600 shadow-[0_0_10px_rgba(154,52,18,0.4)]"
