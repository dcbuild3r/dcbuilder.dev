                    ...
                    <div className="flex items-center justify-center sm:justify-end gap-2">
                      ...
                      <a
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-full transition-colors ${
                          isHotJob(job)
                            ? "bg-gradient-to-r from-orange-700 to-amber-700 dark:from-orange-700 dark:to-amber-700 text-white hover:from-orange-800 hover:to-amber-800 dark:hover:from-orange-600 dark:hover:to-amber-600 shadow-[0_0_10px_rgba(194,65,12,0.4)]"
