...
export const affiliations: Affiliation[] = [
	{
		...
		dateEnd: "Present",
		description:
			"Working on the World Foundation Human Collective Grants program (world.org/community-grants), protocol research and engineering, decentralization of the World ecosystem, and supporting the World mission.",
