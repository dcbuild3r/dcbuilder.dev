...
export const newsletterCampaigns = pgTable(
  "newsletter_campaigns",
  {
    ...
    archiveSubject: text("archive_subject"),
    archivePreviewText: text("archive_preview_text"),
    archiveContentMode: text("archive_content_mode"),
    archiveMarkdownContent: text("archive_markdown_content"),
    archiveManualHtml: text("archive_manual_html"),
    archiveManualText: text("archive_manual_text"),
    archiveRenderedHtml: text("archive_rendered_html"),
    archiveRenderedText: text("archive_rendered_text"),
    archiveCorrectedAt: timestamp("archive_corrected_at"),
