...
export default async function Image({ params }: Props) {
  ...
  const post = await withDataFallback('blog.opengraph', getPublicPostBySlug(slug), null);
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage: 'radial-gradient(circle at 80% 20%, #1a1a2e 0%, #0a0a0a 40%)',
        padding: 60,
      }}
    >
      {/* Top: Author info */}
      ...
      >
        ...
        {date && <div style={{ fontSize: 36, color: '#ddd' }}>{date}</div>}
      </div>
