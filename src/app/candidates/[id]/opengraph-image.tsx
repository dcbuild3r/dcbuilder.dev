...
function selectOneLineSkills(skills: string[]) {
  ...
  for (const skill of skills) {
    const nextWidth = usedWidth + (selected.length > 0 ? SKILL_GAP : 0) + estimateSkillWidth(skill);
  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage: 'radial-gradient(circle at 80% 20%, #2e1a2e 0%, #0a0a0a 40%)',
        padding: 60,
      }}
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ color: '#ffffff', fontSize: 42, fontWeight: 600 }}>dcbuilder.eth</span>
      ...
      >
        ...
        {image ? (
          ...
          >
            <img src={image} alt={name} width={240} height={240} style={roundImageStyle(240)} />
          </div>
        ) : (
          <div
            style={{
