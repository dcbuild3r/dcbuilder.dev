...
import { getPublicCandidatesFromDB, getBaseUrl } from '@/lib/data';
...
export default async function Candidates() {
  const candidates = await withDataFallback('candidates.list', getPublicCandidatesFromDB(), []);
        ...
        <div className="max-w-5xl mx-auto py-8 sm:py-12 space-y-6 sm:space-y-8">
          ...
          <section className="text-center space-y-4">
            ...
            <p className="max-w-2xl mx-auto text-lg text-neutral-700 dark:text-neutral-300">
              Talented builders looking for new opportunities. I&apos;ve personally vouched for each
              of these candidates.
            </p>
          </section>
          ...
          <div className="max-w-2xl mx-auto p-4 rounded-lg bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700">
            ...
            <ul className="text-sm text-neutral-600 dark:text-neutral-400 space-y-2">
              <li>
                • <strong>Public profiles:</strong> Contact the candidate directly via their social
                links
              </li>
              <li className="flex items-start gap-1">
                <span>•</span>
                <span>
                  <strong>Anonymous profiles:</strong> Request an introduction through me on{' '}
                  <a
              ...
              <li className="flex items-start gap-1">
                <span>•</span>
                <span>
                  <strong className="text-green-600 dark:text-green-400">✓</strong> = I personally
                  know and vouch for this candidate
                </span>
              </li>
              <li className="flex items-start gap-1">
                <span>•</span>
                <span>
                  <strong className="text-amber-600 dark:text-amber-400">◇</strong> = Referred
                  candidate (not personally known, proceed with caution)
                </span>
              </li>
            </ul>
          </div>
